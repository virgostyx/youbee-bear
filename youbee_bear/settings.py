"""
Django settings for youbee_bear project.
...
WSGI_APPLICATION = 'youbee_bear.wsgi.application'
...
if "CI" in os.environ:                                                  # For Heroku
    TEST_RUNNER = "youbee_bear.settings.HerokuDiscoverRunner"      # Attention, carefully update
